...
Public Class filtroGrillaSax
    ...
    'Dim WithEvents _dllData As dllData
...
#Region "propiedades"
    ...
    Public ReadOnly Property meComboColumnas() As Wisej.Web.ComboBox
        ...
        End Get
    End Property
    Public ReadOnly Property meTextBoxFiltro() As Wisej.Web.TextBox
        Get
...
#Region "Eventos"
    ...
    End Sub
    Private Sub txtFiltros_EnterKeyDown(objSender As Object, e As KeyPressEventArgs) Handles txtFiltros.KeyPress
        ...
        If I_TABLA_EXPRESIONES IsNot Nothing Then
            ...
            If col.DataType.Name.Contains("Date") Then
                If txtFiltros.Visible Then
                    ...
                    btnLimpiar.Location() = New Point(BtnExportar.Location.X - (txtFiltros.Width - dtpFecha.Width), BtnExportar.Location.Y)
                    btnLimpiar.Location() = New Point(btnElegirColumnas.Location.X - (txtFiltros.Width - dtpFecha.Width), btnElegirColumnas.Location.Y)
                    btnLimpiar.Location() = New Point(btnBDFile.Location.X - (txtFiltros.Width - dtpFecha.Width), btnBDFile.Location.Y)
...
#End Region
    ...
    Private Sub crearEtiquetaFiltro(texto As String, campo As String, valor As String, Id As Integer, expresion As String)
        Try
            ...
            boton.BackgroundImageSource = "Resources/Images/filtro grilla/quitar_etiqueta.png"
