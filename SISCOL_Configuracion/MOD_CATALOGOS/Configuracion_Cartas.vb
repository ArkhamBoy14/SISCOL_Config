...
Public Class Configuracion_Cartas
    ...
    'Private Sub opcDRO_CheckedChanged(sender As Object, e As EventArgs)
    '    ImprimirDocumento()
    'End Sub



    'Private Sub Chk_Especifica_CheckedChanged(sender As Object, e As EventArgs)
    ...
    'Private Sub Chk_Clasificacion_CheckedChanged(sender As Object, e As EventArgs)
